 ...
 return (
   <View style={styles.container}>
    ...
    <ScrollView style={styles.content}>
        ...
        <Text style={styles.label}>Escolha seu nível de atividade física:</Text>
        <Select
             control={control}
             name='level'
             placeholder='Selecione o nível e atividade física'
             error={errors.level?.message}
             options={levelOptions}
        />

        <Text style={styles.label}>Escolha seu objetivo</Text>
        <Select
             control={control}
             name='objective'
             placeholder='Selecione o nível e atividade física'
