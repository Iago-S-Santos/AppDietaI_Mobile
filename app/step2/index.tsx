...
export default function Nutrition() {
    ...
    const { data, isFetching, error } = useQuery({
        ...
        queryFn: async () => {
            try{
              if(!user){
                throw new Error("Failed load step2")
              }
    ...
    if(isFetching){
        return(
            <View style={styles.loading}>
                <Text style={styles.loadingText}>Estamos criando sua dieta!!</Text>
                <Text style={styles.loadingText}>Esperando pela IA...</Text>
            </View>
        )
    }
    ...
    if(error){
        return(
            <View style={styles.loading}>
                <Text style={styles.loadingText}>Falha ao criar sua dieta!!</Text>
                <Link href="/step">
                        ...
                        <View style={styles.foods}>
                          {data.refeicoes.map( (refeicao) => (
                            ...
                            <View style={styles.suplements}>
                                ...
                                <Text key={item} style={styles.suplementsContainer}>{item}</Text>
                                ))}
                            </View>
